...
CREATE TABLE tarimas (
    ...
    codigo_barras CHAR(30) UNIQUE NOT NULL,
    numero_producto CHAR(6) NOT NULL,
    numero_tarima CHAR(6) NOT NULL,
    numero_usuario CHAR(2) NOT NULL,
    cantidad_cajas INT NOT NULL,
    peso DECIMAL(10,2) DEFAULT 0.00,
    numero_venta CHAR(9) NOT NULL,
    descripcion TEXT,
    id_usuario INT,
...
CREATE TABLE historial_tarimas (
    ...
    numero_producto CHAR(6),
    numero_tarima CHAR(6),
    numero_usuario CHAR(2),
    cantidad_cajas INT,
    peso DECIMAL(10,2),
    numero_venta CHAR(9),
    descripcion TEXT,
