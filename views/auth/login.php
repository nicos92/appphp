            ...
            <div class="card p-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?= BASE_URL ?>/auth/login">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group position-relative">
                                ...
                                <span class="password-toggle position-absolute end-0 top-50 translate-middle-y pe-3" style="cursor: pointer; z-index: 5;" onclick="togglePassword('password', 'toggleIcon')">
                    ...
                    <div class="text-center mt-3">
                        <p>¿No tiene una cuenta? <a href="<?= BASE_URL ?>/auth/register">Regístrese aquí</a></p>
